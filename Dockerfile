...
# docker build -t turbo_rails_quote_editor .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name turbo_rails_quote_editor turbo_rails_quote_editor
